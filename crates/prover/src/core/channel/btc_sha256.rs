...
use crate::core::vcs::btc_sha256_merkle::bitcoin_num_to_bytes;

pub const FELTS_PER_HASH: usize = 8;

/// A channel that can be used to draw random elements from a SHA256 hash.
#[derive(Clone, Default)]
pub struct BTCSha256Channel {
    digest: BTCSha256Hash,
    pub channel_time: ChannelTime,
}

impl BTCSha256Channel {
    pub const fn digest(&self) -> BTCSha256Hash {
        self.digest
    }
    pub fn update_digest(&mut self, new_digest: BTCSha256Hash) {
...
impl Channel for BTCSha256Channel {
    ...
    fn mix_u64(&mut self, value: u64) {
        ...
        self.digest = BTCSha256Hasher::concat_and_hash(&BTCSha256Hash(hash), &self.digest);
    }
...
mod tests {
    ...
    use crate::core::channel::btc_sha256::BTCSha256Channel;
